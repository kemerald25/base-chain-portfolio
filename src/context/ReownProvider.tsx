...
const metadata = {
  name: 'Base Chain Portfolio',
  description: 'Multi-chain portfolio aggregator with social copy trading on Base',
  url: typeof window !== 'undefined' ? window.location.origin : 'https://base-chain-portfolio.app', // Replace YOUR_APP_URL
  icons: ['/icon.png'], // Replace YOUR_ICON_URL
}
